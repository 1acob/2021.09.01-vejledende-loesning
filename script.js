...
/* her henter jeg fra og til datoerne som kunden gerne vil leje bilen.*/ 
...
function handleSearch(event) {
  ...
  fetch("https://api.jsonbin.io/v3/b/613680e7dfe0cf16eb56267b/latest", {
    headers: {
      "X-Master-Key":
        "$2b$10$6P4BXB/CNitkiOGBBvFSJ.Rlpg5I8TuFwEhTzaUFDSfzRaSWxnEyy",
      "X-Bin-Meta": false,
    },
  })
        ...
        for (var car of cars) {
          ...
          */
          ...
          if (carsList.innerHTML === "") {
            carsList.innerHTML = "<p class='no-results'>Vi har Desværre ingen biler der passer til dine kriterier.</p>";
          }
        })
          .catch(function (error) {
            /* Hvis API'et svarer med en fejl viser vi den til brugeren */
            carsList.innerHTML = `<div class="Fisk"><p class="error-message">Noget gik galt: "${error.message}".</p></div>`;
          });

  /* Hvis listen stadig er tom efter vi har checket om nogen af bilerne opfylder
   * kriterierne, så indsæt en besked om at intet blev fundet. */
